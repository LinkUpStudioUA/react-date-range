  ...
  _createClass(DateRangeMultiple, [{
    ...
    value: function setSelection(value, isSingleValue) {
      ...
      this.setState({
        ...
        preview: null,
        infiniteRange: [].concat(_toConsumableArray(this.state.infiniteRange), [newSelection.range])
      });
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.ranges != this.props.ranges) {
        infiniteRange = (0, _utils.concatRanges)(this.props.ranges, this.props.mergeRanges);
        this.setState({ infiniteRange: infiniteRange });
        // this.setState({
