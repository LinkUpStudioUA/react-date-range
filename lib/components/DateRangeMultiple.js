  ...
  _createClass(DateRangeMultiple, [{
    ...
    value: function destroyRange(date) {
      ...
      var filteredRanges = infiniteRange.filter(function (range) {
        if ((0, _isBefore2.default)(range.startDate, date) && (0, _isAfter2.default)(range.endDate, date)) {
          removedRange = range;
        }
        return !((0, _isBefore2.default)(range.startDate, date) && (0, _isAfter2.default)(range.endDate, date));
      });
