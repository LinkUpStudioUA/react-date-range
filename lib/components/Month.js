...
var Month = function (_PureComponent) {
  ...
  _createClass(Month, [{
    ...
    value: function render() {
      ...
      var days = (0, _eachDayOfInterval2.default)({ start: monthDisplay.start, end: monthDisplay.end });
      return _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          ...
          days.map(function (day, index) {
            ...
            var prevDayIsDisable = disabledDates.some(function (disabledDate) {
              return (0, _isSameDay2.default)(disabledDate, days[index - 1]);
            });
            var nextDayIsDisable = disabledDates.some(function (disabledDate) {
              return (0, _isSameDay2.default)(disabledDate, days[index + 1]);
            });
            return _react2.default.createElement(_DayCell2.default, _extends({}, _this2.props, {
              ...
              styles: styles,
              removeRange: _this2.props.removeRange,
