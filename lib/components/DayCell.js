  ...
  _createClass(DayCell, [{
    ...
    value: function touchstart(event) {
      ...
      this.timer = setTimeout(function () {
        console.log('removeRange');_this2.props.removeRange(_this2.props.day);
      }, this.touchduration);
    }
  }, {
    key: 'touchend',
      ...
      switch (event.type) {
        ...
        case 'focus':
          if (event.nativeEvent.which == 3) {
            ...
            this.timer = setTimeout(function () {
              _this3.props.removeRange(_this3.props.day);
            }, this.touchduration);
          } else {
            onPreviewChange(day);
          }
    ...
    value: function renderSelectionPlaceholders() {
      ...
      return inRanges.map(function (range, i) {
        ...
        return _react2.default.createElement('span', {
          ...
          style: { color: range.color || _this4.props.color }
        });
      });
    }
...
DayCell.propTypes = {
  ...
  disabled: _propTypes2.default.bool,
  prevDayIsDisable: _propTypes2.default.bool,
  nextDayIsDisable: _propTypes2.default.bool,
