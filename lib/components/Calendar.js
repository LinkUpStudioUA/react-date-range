...
var Calendar = function (_PureComponent) {
  ...
  function Calendar(props, context) {
    ...
    _this.yearOptions = [];
    _this.selectedMonth = {};
    var currentYear = (0, _getYear2.default)((0, _utils.calcFocusDate)(null, props));
    _this.selectedYear = {
      value: currentYear,
      label: currentYear
    };
    var upperYearLimit = (props.maxDate || Calendar.defaultProps.maxDate).getFullYear();
    var lowerYearLimit = (props.minDate || Calendar.defaultProps.minDate).getFullYear();
    props.locale.localize.months().map(function (month, i) {
      var currentMonth = (0, _getMonth2.default)((0, _utils.calcFocusDate)(null, props));
      if (currentMonth == i) {
        _this.selectedMonth = {
          value: i,
          label: month
  ...
  _createClass(Calendar, [{
    ...
    value: function renderDateDisplay() {
      ...
      var _props3 = this.props,
          ...
          infiniteRange = _props3.infiniteRange;

      var defaultColor = rangeColors[focusedRange[0]] || color;
      var styles = this.styles;
      var displayRanges = ranges.concat(infiniteRange);
      return _react2.default.createElement(
        'div',
        { className: styles.dateDisplayWrapper },
        displayRanges.map(function (range, i) {
            ...
            _react2.default.createElement(_reactList2.default, {
              ...
              itemRenderer: function itemRenderer(index, key) {
                ...
                return _react2.default.createElement(_Month2.default, _extends({}, _this5.props, {
                  ...
                  month: monthStep,
                  removeRange: _this5.props.removeRange,
...
Calendar.propTypes = {
  ...
  infiniteRange: _propTypes2.default.arrayOf(_DayCell.rangeShape),
  ...
  withoutFocus: _propTypes2.default.bool,
