...
var DateRange = function (_Component) {
  ...
  _createClass(DateRange, [{
    ...
    value: function setSelection(value, isSingleValue) {
      ...
      var infiniteRange = this.props.infiniteRange;
      if (isInfinite && focusedRange[1] == 1) {
        ...
        infiniteRange = (0, _utils.concatRanges)(infiniteRange, this.props.mergeRanges);
        newSelection.nextFocusRange = [0, 0];
      }
      onChange(_defineProperty({}, selectedRange.key || 'range' + (focusedRangeIndex + 1), _extends({}, selectedRange, newSelection.range)), infiniteRange);
      this.setState({
    ...
    value: function destroyRange(date) {
      var removeRange = this.props.removeRange;
      ...
      infiniteRange = (0, _utils.concatRanges)(filteredRanges, this.props.mergeRanges);
